...
const STATIC_ROUTES: Entry[] = [
  ...
  { path: "/tiktok-slideshow-downloader", lastmod: today, changefreq: "weekly", priority: "0.9" },
  { path: "/tiktok-story-downloader", lastmod: today, changefreq: "weekly", priority: "0.9" },
  { path: "/tiktok-mp3-converter", lastmod: today, changefreq: "weekly", priority: "0.9" },
  { path: "/tiktok-to-mov-converter", lastmod: today, changefreq: "weekly", priority: "0.9" },
  { path: "/tiktok-live-downloader", lastmod: today, changefreq: "weekly", priority: "0.9" },
