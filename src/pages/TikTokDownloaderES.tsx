        ...
        <section className="py-12 px-4 bg-muted/30">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="glass-card rounded-2xl p-5">
                <h3 className="font-bold text-primary mb-3">🖼️ Slideshow y Carrusel</h3>
                <div className="flex flex-wrap gap-2">
                  {["tiktok slideshow", "descargar carrusel", "fotos tiktok", "modo foto tiktok"].map((k, i) => (
                    <span key={i} className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">{k}</span>
                  ))}
                </div>
              </div>
              ...
              <div className="glass-card rounded-2xl p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {["tiktok 4K", "tiktok HD 1080p", "video alta calidad", "descargar tiktok 4K"].map((k, i) => (
                    <span key={i} className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">{k}</span>
                  ))}
                </div>
              </div>
              ...
              <div className="glass-card rounded-2xl p-5">
                <h3 className="font-bold text-primary mb-3">🎬 Live y Stories</h3>
                <div className="flex flex-wrap gap-2">
                  {["tiktok live descargar", "tiktok story", "tiktok clips", "descargar en vivo"].map((k, i) => (
                    <span key={i} className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">{k}</span>
                  ))}
                </div>
              </div>
