          ...
          <div className="glass-card rounded-3xl p-6 md:p-10">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  AnyTT is a video downloading tool that provides links to content hosted on third-party platforms (TikTok, YouTube, Facebook). We do not host, store, or control any video content. All videos remain on their original platforms.
                </p>
              </section>
